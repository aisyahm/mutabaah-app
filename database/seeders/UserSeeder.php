...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //USER UKHTI
        User::create([ "name" => "Atik", "email" => "atik@gmail.com", "password" => Hash::make("atk"), "no_telp" => 9326928900, "description" => "Awardee YDS-FWD UKHTI", "gender" => "Ukhti", "is_mentor" => false ]);
        ...
        User::create([ "name" => "Pinkan", "email" => "pinkan@gmail.com", "password" => Hash::make("pin"), "no_telp" => 333345892, "description" => "Mentor YDS-FWD UKHTI", "gender" => "Ukhti", "is_mentor" => true ]);
    }
}
