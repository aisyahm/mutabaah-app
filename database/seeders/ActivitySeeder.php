...
class ActivitySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Activity::create(["name" => "Infaq", "category" => 4]);
        Activity::create(["name" => "Kajian", "category" => 4]);
        //Dzikir
        Activity::create(["name" => "Dzikir Pagi", "category" => 5]);
        Activity::create(["name" => "Dzikir Petang", "category" => 5]);
        Activity::create(["name" => "Istighfar", "category" => 5]);
        Activity::create(["name" => "Sholawat", "category" => 5]);
