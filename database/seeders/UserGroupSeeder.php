...
class UserGroupSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        UserGroup::create([ "user_id" => 3, "group_id" => 2, "is_accept" => false ]);
        UserGroup::create([ "user_id" => 3, "group_id" => 1, ]);
        UserGroup::create([ "user_id" => 4, "group_id" => 1, "is_accept" => false ]);
        ...
        UserGroup::create([ "user_id" => 9, "group_id" => 3, "is_accept" => true ]); //Aisyah
    }
}
